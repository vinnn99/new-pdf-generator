...
/**
 * Template: Berita Acara MDS HOLD
 *
 * Field payload.data yang diharapkan:
 * - letterNo        (string, wajib)   : Nomor surat, contoh "097/OMI-TM/BAK/IV/2026"
 * - region          (string, wajib)   : Wilayah, contoh "JTU"
 * - holdDate        (string/ISO)      : Tanggal mulai hold, contoh "2026-04-01"
 ...
 */
module.exports = function baHoldTemplate(payloadData = {}) {
  const {
    letterNo = '',
    region = '',
    holdDate = '',
  ...
  return {
    ...
    content: [
      ...
      {
        text: [
          'Pemberitahuan MDS HOLD untuk Wilayah ',
          { text: upper(region) || '-', bold: true },
          ' per tanggal ',
          { text: formatDateUpper(holdDate), bold: true },
